...
|---|---|---|---|
| Detachable Soft Actuators with Tunable Stiffness Based on Wire Jamming | core_protocol_anchor | not required | not_screened |
| A Positive Pressure Jamming Based Variable Stiffness Structure and its Application on Wearable Robots | core_protocol_anchor | not required | not_screened |
| A variable stiffness omnidirectional chain based on positive-pressure fiber jamming | core_protocol_anchor | not required | not_screened |
| Variable-Stiffness and Deformable Link Using Shape-Memory Material and Jamming Transition Phenomenon | core_protocol_anchor | not required | not_screened |
| Effect of R-phase on shape recovery speed of Ti-Ni shape memory alloy wire for variable-stiffness mechanism using jamming transition phenomenon | core_protocol_anchor | not required | not_screened |
...
- NOT SCREENED: Detachable Soft Actuators with Tunable Stiffness Based on Wire Jamming [forward]
- NOT SCREENED: A Positive Pressure Jamming Based Variable Stiffness Structure and its Application on Wearable Robots [forward]
- NOT SCREENED: A variable stiffness omnidirectional chain based on positive-pressure fiber jamming [forward]
- NOT SCREENED: Variable-Stiffness and Deformable Link Using Shape-Memory Material and Jamming Transition Phenomenon [forward]
- NOT SCREENED: Effect of R-phase on shape recovery speed of Ti-Ni shape memory alloy wire for variable-stiffness mechanism using jamming transition phenomenon [forward]
...
A true stop condition is protocol closure only; it is not proof that no overlapping paper exists anywhere.
