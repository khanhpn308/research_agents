...
# MASTER EXECUTION PLAN V3

## 1. Plan identity and remediation provenance

- PLAN_VERSION: V3
- SOURCE_PLAN_VERSION: V2
- SOURCE_PLAN: outputs/plans/D1_M1_NOVELTY_RECONSTRUCTION_PLAN_V2.md
- SOURCE_REAUDIT: outputs/plans/D1_MASTER_PLAN_REAUDIT_V2.md
- REMEDIATION_TASK: D1-R2
...
This V3 is a plan artifact only. It does not execute the scientific audit, launch workers, search literature, extract paper evidence, implement M1, run FE, collect data, analyze MP1, compare D1 with MP1, or modify scientific verdicts.

V3 binding sections 23 onward supersede any conflicting inherited V2 clause. The inherited V2 sections are retained for traceability; execution must use the V3 registers, worker contracts, hard gates and dependency graph defined below.
